...
Credit Risk Segmentation – Alteryx & Power BI
Overview
...
The Alteryx workflow follows a structured pipeline:
...
Replaced missing values in Saving and Checking accounts with a consistent category

This ensured downstream scoring logic was stable and reproducible.
...
Lower skill levels were assigned higher risk weights to reflect potential income volatility.
...
All risk components were aggregated into a total score.
